<%-- 
    Document   : yoga
    Created on : Apr 14, 2025, 3:59:56 PM
    Author     : Madelyn Yap
--%>
...
<%
    ...
    try {
        ...
        productList = productDAO.getProductsByCategory("C101"); 
        conn.close();
    } catch (Exception e) {
    ...
    <body>
        ...
        <section class="video-hero" id="video-hero">
            <video autoplay muted loop playsinline class="video-bg">
                <source src="${pageContext.request.contextPath}/images/yoga.mp4" type="video/mp4">

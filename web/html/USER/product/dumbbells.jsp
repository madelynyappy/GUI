...
<%
    ...
    try {
        ...
        productList = productDAO.getProductsByCategory("C100"); 
        conn.close();
    } catch (Exception e) {
    ...
    <body>
        ...
        <section class="video-hero" id="video-hero">
            <video autoplay muted loop playsinline class="video-bg">
                <source src="${pageContext.request.contextPath}/images/dumbells.mp4" type="video/mp4">

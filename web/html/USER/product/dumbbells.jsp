<%-- 
    Document   : dumbbells
    Created on : Apr 14, 2025, 3:59:34 PM
    Author     : Madelyn Yap
--%>
...
<%
    ...
    try {
        ...
        // Assuming "DB" is the category ID for dumbbells
        productList = productDAO.getProductsByCategory("DB");
        conn.close();
    } catch (Exception e) {
    ...
    <body>
        ...
        <section class="product-section">
            <div class="section-header">
                <h2>Dumbbells Collection</h2>
                <a href="product.jsp" class="see-more-link">View All Products<i class="bi bi-arrow-right"></i></a>
            </div>

<%-- 
    ...
    Created on : Apr 14, 2025, 4:02:24 PM
    Author     : Madelyn Yap
--%>
...
<%
    ...
    try {
        ...
        productList = productDAO.getProductsByCategory("C103"); 
        conn.close();
    } catch (Exception e) {
...
<html>
    <head>
       ...
       <link rel="stylesheet" href="${pageContext.request.contextPath}/css/categoryDetails.css">
        <title>Accessories | FITHUB </title>
    </head>
    <body>
        <%@ include file="../home/header.jsp" %>
         ...
         <section class="video-hero" id="video-hero">
            <video autoplay muted loop playsinline class="video-bg">
                <source src="${pageContext.request.contextPath}/images/accessories.mp4" type="video/mp4">
